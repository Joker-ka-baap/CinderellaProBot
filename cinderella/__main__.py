...
if START_IMG is None:
    img = "https://telegra.ph/file/884ecfc09e0cabf059d7b.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/joker_ka_baap")]]
    keyboard += [[InlineKeyboardButton(text="🌐Connect Group", callback_data="main_connect"),InlineKeyboardButton(text="⚜️Add Me⚜️",url="t.me/MissSelinia_bot?startgroup=true".format(bot.username))]]
